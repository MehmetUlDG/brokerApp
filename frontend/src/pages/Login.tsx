    ...
    <div className="fixed inset-0 z-[100] bg-white flex flex-col font-sans overflow-y-auto selection:bg-[#B5FF45]">
      ...
      <header className="relative z-10 w-full px-[48px] h-[80px] flex items-center justify-between border-b border-[#F0F0F0] bg-white/80 backdrop-blur-md">
        ...
        <nav className="flex items-center gap-[32px]">
          ...
          <Link to="/login" className="text-[14px] text-black font-bold relative pb-1">
            Login
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-[#B5FF45]" />
          </Link>
          <Link to="/register" className="text-[14px] text-[#666666] hover:text-black transition-colors">Register</Link>
        </nav>
      ...
      <main className="relative z-10 flex-1 flex justify-center items-center py-[60px]">
        <div className="w-[480px] bg-white p-[48px] rounded-[16px] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-[#F0F0F0]">
          ...
          <div className="mb-[40px]">
            <p className="text-[11px] font-bold tracking-[0.15em] text-[#999999] uppercase mb-[12px]">Access Terminal</p>
            <h1 className="text-[36px] font-extrabold text-black leading-[1.1] mb-[12px]">
              Welcome back to <br /> TRADEX.
            </h1>
            <p className="text-[14px] text-[#666666]">Secure authentication required for market access.</p>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-[24px]">
            <div>
              <label className="block text-[10px] font-bold text-[#999999] uppercase mb-[8px] tracking-wider">Network Identifier</label>
              <input 
            ...
            <div className="relative">
              <div className="flex justify-between items-center mb-[8px]">
                <label className="text-[10px] font-bold text-[#999999] uppercase tracking-wider">Security Protocol</label>
                <button type="button" className="text-[10px] font-bold text-[#88B04B] uppercase hover:underline">Reset Credentials</button>
              </div>
              <div className="relative">
                <input 
            ...
            <label className="flex items-center gap-[10px] cursor-pointer group">
              ...
              <span className="text-[12px] text-[#666666] select-none">Persistent Session State</span>
            </label>
            ...
            <div className="relative py-[20px] flex items-center justify-center">
              ...
              <span className="relative px-[16px] bg-white text-[10px] font-bold text-[#999999] uppercase tracking-widest">Or Authenticate With</span>
            </div>
